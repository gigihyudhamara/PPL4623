<?php
    ...
    $data = mysqli_query($mysqli, "SELECT id_detail_project, nama_project, project_desainer, deskripsi, time_relesead, genre  FROM detail_project");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Prapendaftaran Game</h1>
          </div>
          ...
          <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form action="proses_daftar_game.php" method="POST">Select Game<br>
                    <select name="detail_project" class="form-control">
                        <?php
                            while ($da = mysqli_fetch_array($data)){
                        ?>
                        <option value="<?php echo $da['id_detail_project']; ?>"><?php echo $da['nama_project'];?></option>
                        <?php
                            }
                        ?>
