<?php
    ...
    $data = mysqli_query($mysqli, "SELECT * FROM user_desainer WHERE id_user_desainer='$id_user_desainer'");
          ...
          <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <form action="proses_edit_profil.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_user_desainer" value="<?php echo $dr['id_user_desainer']; ?>">
                    Nama Lengkap:<br>
                    <input type="text" name="nama_lengkap" value="<?php echo $dr['nama_lengkap']; ?>" class="form-control"><br><br>
                    Username:<br>
                    <input type="text" name="username" value="<?php echo $dr['username'];?>"class="form-control"><br><br>
                    Email:<br>
                    <?php echo $dr['email']; ?><br><br>
                    Tempat Lahir:<br>
                    <input type="text" name="tempat_lahir" value="<?php echo $dr['tempat_lahir'];?>"class="form-control"><br><br>
                    Tanggal Lahir:<br>
                    <input type="text" name="tanggal_lahir" value="<?php echo $dr['tanggal_lahir'];?>"class="form-control">Format: YYYY-BB-HH<br><br>
                    Alamat:<br>
                    <textarea name="alamat" class="form-control"><?php echo $dr['alamat'];?></textarea><br><br>
                    Nomor Handphone: <br>
                    <input type="text" name="no_hp" value="<?php echo $dr['no_hp'];?>"class="form-control"><br><br>
                    Foto<br>
