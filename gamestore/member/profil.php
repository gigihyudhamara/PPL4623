          ...
          <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <form action="proses_edit_profil.php" method="POST" enctype="multipart/form-data">
                    ...
                    Nama Lengkap:<br>
                    <input type="text" name="nama_lengkap" value="" class="form-control"><br><br>
                    Username:<br>
                    <input type="text" name="username" value=""class="form-control"><br><br>
                    Email:<br>
                    <br><br>
                    Tempat Lahir:<br>
                    <input type="text" name="tempat_lahir" value=""class="form-control"><br><br>
                    Tanggal Lahir:<br>
                    <input type="text" name="tanggal_lahir" value=""class="form-control">Format: YYYY-BB-HH<br><br>
                    Alamat:<br>
                    <textarea name="alamat" class="form-control"></textarea><br><br>
                    Nomor Handphone: <br>
                    <input type="text" name="no_hp" value=""class="form-control"><br><br>
                    Foto<br>
                    <img src=""><br>
