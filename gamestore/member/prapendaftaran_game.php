<?php
    ...
    $data = mysqli_query($mysqli, "SELECT id_game, nama_game, game_developer, time_relesed, genre FROM gamelist");
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">Consol Game PS 4 </div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="gamelist.php?id_member=<?php echo $_SESSION['id_member'];?>">
        ...
        <div class="container-fluid">
          ...
          <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                Select Game<br>
                    <select name="gamelist" class="form-control">
                        <?php
